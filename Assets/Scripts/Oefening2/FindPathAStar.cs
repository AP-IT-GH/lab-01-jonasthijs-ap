...
public class FindPathAStar : MonoBehaviour
{
    ...
    IEnumerator Searching()
    {
        ...
        {
            // Perform some task
            Debug.Log("Searching coroutine is running...");
            Search(lastPos);
        ...
        Debug.Log("Searching coroutine finished!");
    }
    ...
    {
        Debug.Log("Following of path coroutine started!");
        ...
        while (!atEndOfPath)
        {
            startNode.marker.transform.position = new Vector3(path[index].marker.transform.position.x, path[index].marker.transform.position.y, path[index].marker.transform.position.z);
        ...
        Debug.Log("Following of path coroutine ended!");
    }
}
